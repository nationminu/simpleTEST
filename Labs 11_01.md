...
## JBOSS Cluster 설정 
  1. NODE_NAME설정
    ...
    ```
    export NODE_NAME=$SERVER_NAME <br />
  ...
  3. JBOSS UDP cluster 설정 
    1. env.sh 에 jgoups.stack , multicast ip 설정 <br />
        ```
        export MULTICAST_ADDR=230.1.0.1   # Default로 45688 사용 (standalone-ha.xml)<br />
        ...
        # jgroups setting<br />
        export JAVA_OPTS=" $JAVA_OPTS -Djboss.default.jgroups.stack=udp"<br />
  ...
  4. Application web.xml 태그 추가 
    1. web.xml 에 <distributable /> 태그 추가 <br />
        ...
        <web-app xmlns="http://java.sun.com/xml/ns/javaee"<br />
                ...
                version="2.5"><br />
            <display-name>simple test</display-name><br />
            <distributable/> <br />
        ...<br />
        </web-app>
        ```
